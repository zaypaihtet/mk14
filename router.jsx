...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/lottery-three-d-betting", element: <PrivateRoute><LotteryThreeDBetting /></PrivateRoute> },
      { path: "/lottery-two-d-betting", element: <PrivateRoute><LotteryTwoDBetting /></PrivateRoute> },
      { path: "/lottery-two-d-confirmation", element: <PrivateRoute><LotteryTwoDConfirmation /></PrivateRoute> },
